describe("Date helper ", function() {
    ...
    it("will not throw error if all sub params are valid", function() {
        var dateHelperDate = dateHelper(new Date(2015, 5, 12));
        expect(dateHelperDate.sub.bind(null, "year", 1)).to.not.throw(Error);
    });

    it("will throw error if add gets negative amount param", function() {
        var dateHelperDate = dateHelper(new Date(2015, 5, 12));
    ...
    it("will throw error if sub gets negative amount param", function() {
        var dateHelperDate = dateHelper(new Date(2015, 5, 12));
        expect(dateHelperDate.sub.bind(null, "year", -11)).to.throw(Error);
    });

    it("will throw error if sub gets float as amount param", function() {
        var dateHelperDate = dateHelper(new Date(2015, 5, 12));
        expect(dateHelperDate.sub.bind(null, "year", 2.5)).to.throw(Error);
    });
});
